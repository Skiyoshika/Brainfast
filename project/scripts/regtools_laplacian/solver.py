...
Vendored into Brainfast on 2026-04-16 as project/scripts/regtools_laplacian/solver.py.
Unmodified from upstream except for this header — do not edit locally; update
by re-syncing from upstream.

--- Original header ---
Non-linear Laplacian registration in 3D space.
...
def solveLaplacianFromCorrespondences(
    ...
    A = laplacianA3D(vol_shape, boundary_indices, spacing=spacing, log_fn=log)
