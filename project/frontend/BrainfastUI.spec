...
"""
Brainfast PyInstaller spec — onedir build for fast startup.
Output: dist/BrainfastUI/BrainfastUI.exe
"""
...
FRONTEND = Path(SPEC).parent           # d:\Brainfast\project\frontend
PROJECT  = FRONTEND.parent             # d:\Brainfast\project
